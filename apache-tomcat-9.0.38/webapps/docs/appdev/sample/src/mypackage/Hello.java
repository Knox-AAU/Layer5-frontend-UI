...
/**
 * Simple servlet to validate that the Hello, World example can execute servlets. In the web
 * application deployment descriptor, this servlet must be mapped to correspond to the link in the
 * "index.html" file.
 *
