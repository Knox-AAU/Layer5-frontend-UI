...
public class CompressionServletResponseWrapper extends HttpServletResponseWrapper {
  ...
  /**
   * Calls the parent constructor which creates a ServletResponse adaptor wrapping the given
   * response object.
   *
   ...
   *
   * @param mimeTypes The new list of mime types that will be considered for compression
   */
   ...
   * @return A new servlet output stream that compressed any data written to it
   */
  protected ServletOutputStream createOutputStream() throws IOException {
    ...
    CompressionResponseStream stream =
        new CompressionResponseStream(this, origResponse.getOutputStream());
   ...
   *
   * @exception IllegalStateException if <code>getWriter</code> has already been called for this
   *     response
   * @exception IOException if an input/output error occurs
   */
  @Override
