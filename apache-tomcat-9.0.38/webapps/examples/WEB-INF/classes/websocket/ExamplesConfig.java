...
public class ExamplesConfig implements ServerApplicationConfig {
  ...
  public Set<ServerEndpointConfig> getEndpointConfigs(Set<Class<? extends Endpoint>> scanned) {
    ...
    if (scanned.contains(EchoEndpoint.class)) {
      result.add(
          ServerEndpointConfig.Builder.create(EchoEndpoint.class, "/websocket/echoProgrammatic")
              .build());
    }

    if (scanned.contains(DrawboardEndpoint.class)) {
      result.add(
          ServerEndpointConfig.Builder.create(DrawboardEndpoint.class, "/websocket/drawboard")
              .build());
    }
