...
/**
 * A message that represents a drawing action. Note that we use primitive types instead of Point,
 * Color etc. to reduce object allocation.<br>
 * <br>
 * TODO: But a Color objects needs to be created anyway for drawing this onto a Graphics2D object,
 * so this probably does not save much.
 */
public final class DrawMessage {
  ...
  public static DrawMessage parseFromString(String str) throws ParseException {
    ...
    DrawMessage m =
        new DrawMessage(
            type, colors[0], colors[1], colors[2], colors[3], thickness, coords[0], coords[2],
            coords[1], coords[3]);
