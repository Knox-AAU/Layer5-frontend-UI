...
public final class DrawboardEndpoint extends Endpoint {
  ...
  /**
   * The player that is associated with this Endpoint and the current room. Note that this variable
   * is only accessed from the Room Thread.<br>
   * <br>
