...
/**
 * The three annotated echo endpoints can be used to test with Autobahn and the following command
 * "wstest -m fuzzingclient -s servers.json". See the Autobahn documentation for setup and general
 * information.
 *
 * <p>Note: This one is disabled by default since it allocates memory, and needs to be enabled back.
 */
